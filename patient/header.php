                ...
                <div class="header-right">
                    ...
                    <nav class="main-nav ls-20">
                        ...
                        <li>
                            ...
                            <li>
                                <a href="#" class="sf-with-ul">Appointment<i class="fas fa-caret-down"></i></a>
                                <ul class="sub-menu">
                                    <li><a href="appointment-step1.php"><i class="fas fa-angle-right"></i>Book Appointment</a></li>
...
<div class="header-search">
                    ...
                    <a href="appointment-step1.php" class="" role="button"><i class="fal fa-notes-medical"></i></a>          
