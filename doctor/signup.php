...
if(isset($_POST['btnsub'])) {
    ...
    $query = "INSERT INTO user (user_name, user_email, user_date, user_pass)
              VALUES ('".$name."', '".$email."', '".$date."', '".$pass."')";
        ...
        <main class="main">
            ...
            <div class="height-100vh login-section signup-section position-relative bg-section bgcolour">
                ...
                <div class="foreground-img">
					<img src="/assets/images/backgrounds/background-2.jpg" alt="image">					
				</div>
            </div>
            <!------------------------------------------------
	        signup - end
